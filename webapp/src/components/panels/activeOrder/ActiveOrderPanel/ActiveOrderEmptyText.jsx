...
const ActiveOrderEmptyText = ({ anyPendingGroups, anyOrganizedGroups }) => (
  anyOrganizedGroups ?
...
ActiveOrderEmptyText.propTypes = {
...
export default connect(mapStateToProps)(ActiveOrderEmptyText);
